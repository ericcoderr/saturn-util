...
public class DigestUtils {
     ...
     * 
     * @param algorithm the name of the algorithm requested. See <a href="http://java.sun.com/j2se/1.3/docs/guide/security/CryptoSpec.html#AppA">Appendix A in the Java Cryptography Architecture API
     *        Specification & Reference</a> for information about standard algorithm names.
    ...
    public static String md5Hex(String data, Charset charset) {
        return Hex.encodeHexString(md5(data, charset));
    }
    ...
    /**
     * Calculates the SHA-16 digest and returns the value as a <code>byte[]</code>.
     * <p>
     * Throws a <code>RuntimeException</code> on JRE versions prior to 1.4.0.
     * </p>
     * 
     ...
     * @since 1.4
     */
    public static byte[] sha1X16(String data, String encode) {
        byte[] bytes = sha(data);
        ...
        try {
            return sha1StrBuff.toString().getBytes(encode);
